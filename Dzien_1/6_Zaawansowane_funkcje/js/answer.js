...
//
// ### Zadanie 1
// Napisz funkcję ```boilEgg```, która jako argument przyjmie czas w sekundach,
// a jej wywołanie spowoduje, że po zadanym czasie na konsoli wyświetli się komunikat "jajko ugotowane".
...
let timeout= setTimeout(function () {
  console.log('Egg has been boiled');
...
console.log(findMax(5, 29, 6, 4, 34, 56, 2, 3));
